		...
		contents: [
			{
				...
				elements: [
					...
					},
					{
						...
						validate: CKEDITOR.dialog.validate.regex( /^\+?(0|[1-9]\d*)$/, "Paading top is not valid." ),
						setup: function( element, preview ) {
							this.preview_button = preview;
					...
					},
					{
						...
						validate: CKEDITOR.dialog.validate.regex( /^\+?(0|[1-9]\d*)$/, "Paading bottom is not valid." ),
						setup: function( element, preview ) {
							this.preview_button = preview;
							this.setValue( element.getStyle('padding-bottom').split('px')[0] );
						},
						commit: function( element ) {
					...
					},
					{
						...
						validate: CKEDITOR.dialog.validate.regex( /^\+?(0|[1-9]\d*)$/, "Paading left is not valid." ),
						setup: function( element, preview ) {
							this.preview_button = preview;
					...
					},
					{
						...
						validate: CKEDITOR.dialog.validate.regex( /^\+?(0|[1-9]\d*)$/, "Paading right is not valid." ),
						setup: function( element, preview ) {
							this.preview_button = preview;
							this.setValue( element.getStyle('padding-right').split('px')[0] );
						},
						commit: function( element ) {
