...
CKEDITOR.plugins.add('collapsibleItem', {
    ...
    onLoad: function () {
        CKEDITOR.addCss(
            ...
            '.collapsible-item-heading {background-color:#f4f8ef;color:#72b73a;text-decoration:none;font-size:15px;} ' +
            '.collapsible-item-collapse {display:none;background-color:#ddd;min-height:10px;} ' +
            ...
            '.collapsible-item-collapse .in collapsible-item-body {display:block}' +
