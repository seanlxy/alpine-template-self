        ...
        if(elms.length)
        {
            elms.each(function(ins, newCol){
                ...
                CKEDITOR.inline(id, {
                    ...
                    extraPlugins:'sourcedialog,tags,dialogui,dialog,lineutils,widget,notification,notificationaggregator,clipboard,autolink,undo,embedbase,embed,autoembed,panel,floatpanel,richcombo,loremipsum,ckawesome,emojione,autogrow,autosave,symbol,simplebutton,brclear,texttransform,imageresizerowandcolumn,image2',
