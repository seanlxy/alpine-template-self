...
$tags_arr['webfont_headings'] = '
    <style>h1, h2, .h1 .h2, h2 a, .btn, header .booking-btn, .heroshot__caption__text, .control-label{
...
$company_logo = '<a href="/">
                    <img src="'.$company_logo_path.'" alt="Company Logo" style="max-width: 200px; max-height:150px;">
                </a>
                ';
    ...
    $newsletter_view = '
                    <div class="newsletter-wrapper-new">
                      ...
                      <form action="#" id="news-signup-form" method="post">
                        ...
                        <button type="submit" id="newsletter-submit" name="signup" value="singup" class="btn btn-brown">Sign Up</button>
