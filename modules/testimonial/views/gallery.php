...
$testimonial = <<<H
			<div class="col-xs-12 text-center ">
				...
				{$testimonial}
				<p class="pb"><a href="{$page_testimonial->full_url}" class="btn btn-brown-ghost">Read More Reviews</a></p>
			</div>
...
if ($page_url == $page_home->url) {
	...
	if (!empty($testm_arr)) {
		...
		$reviews_link = '<div class="read-reviews-wrap '.$lg_link_class.'"><a class="read-reviews btn btn-brown" href="'.$page_testimonial->full_url.'">Read Reviews</a>
